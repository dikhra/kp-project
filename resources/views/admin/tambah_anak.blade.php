        ...
        <div class="card-body">
            <form action="/child/store" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="panjang_badan" name="panjang_badan"
                            placeholder="Contoh : 75" min="0" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nik_ortu" name="nik_ortu" required
                        placeholder="Nama orang tua">
                </div>

                <div class="form-group">
                    <label for="nomor_telepon">Nomor Telepon Orang Tua*</label>
                    <input type="text" class="form-control" id="no_ortu" name="no_ortu" required
